...
- (UICollectionViewLayoutAttributes *)layoutAttributesForItemAtIndexPath:(NSIndexPath *)path
{
    ...
    attributes.center = CGPointMake(_center.x + _radius * sinf(2 * path.item * M_PI / _cellCount),
                                    _center.y + (1-_radius * cosf(2 * path.item * M_PI / _cellCount)));
  //  NSLog(@"%d:%lf/%lf||%lf/%lf",path.item,attributes.center.x,attributes.center.y,sinf(2 * path.item * M_PI / _cellCount),cosf(2 * path.item * M_PI / _cellCount));
    return attributes;
}
